...
function setupSpecials(){
	...
	new Special("spawn_ophianianChunk", 2800, 666, function(){Hellaxy.ships.ophianian_chunk.spawn(this.ship.sector, this.ship.x, this.ship.y, this.ship.angle, npc.rammer)});
